...
Gem::Specification.new do |s|
  s.name = "acnfp-trans-counter"
  s.version = "0.2.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Robert Syme"]
  s.date = "2011-09-15"
  s.description = "A quick and dirty tool for analysis of transition and transversion frequency aross and alignment"
  ...
  s.homepage = "http://github.com/robsyme/acnfp-trans-counter"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "A quick and dirty tool for analysis of transition and transversion frequency aross and alignment"
  s.test_files = [
    "test/helper.rb",
    "test/test_acnfp-trans-counter.rb"
  ]
